...
const report = {
  artifacts: {
    "solidlil core": bytes(await readFile(join(root, "dist", "core.js"))),
    "solidlil web": bytes(await readFile(join(root, "dist", "web.js"))),
    "solidlil full": bytes(await readFile(join(root, "dist", "full.js"))),
  },
  imports: {
    createSignal: {
  ...
  install: {
    solidlilUnpacked: packageResult.unpackedSize,
    solidDependencyTree: upstreamInstalled,
    reduction: upstreamInstalled ? 1 - packageResult.unpackedSize / upstreamInstalled : 0,
  },
}
